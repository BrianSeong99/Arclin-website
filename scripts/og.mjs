...
<link href="https://fonts.googleapis.com/css2?family=${encodeURIComponent(c.font)}:wght@500&family=Geist:wght@600&family=Geist+Mono&display=swap" rel="stylesheet">
<style>
  body{margin:0;width:1200px;height:630px;background:#f6f4ee;color:#0f1412;font-family:"${c.font}",sans-serif;position:relative;overflow:hidden}
  ...
  .brand b{font-family:"Geist",sans-serif;font-weight:600;font-size:40px;letter-spacing:-.03em}
  ...
  .foot{font-family:"Geist Mono",monospace;font-size:18px;letter-spacing:.2em;color:#1e4d46}
